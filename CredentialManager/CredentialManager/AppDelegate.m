...
-(NSManagedObjectModel *)managedObjectModel
{
    ...
    NSString *modelPath = [[NSBundle mainBundle] pathForResource:@"Credentials"
                                                ofType:@"momd"];
...
-(NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CredentialManager.sqlite"];
